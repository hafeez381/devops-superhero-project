...
resource "aws_instance" "jenkins_instance" {
  ...
  provisioner "local-exec" {
    command = <<EOT
      ...
      ANSIBLE_HOST_KEY_CHECKING = False ansible-playbook -i ${aws_instance.jenkins_instance.public_ip}, --private-key /tmp/private-key.pem -u ubuntu ../ansible/configure-ec2.yml
    EOT
  }
